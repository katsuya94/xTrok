...
public class App {
	...
	// Setup variables
	private final String WINDOW_TITLE = "xTrok";
	...
	private void setupShaders() {
		...
		vsId = this.loadShader("src/shaders/vertex.glsl", GL20.GL_VERTEX_SHADER);
		// Load the fragment shader
		fsId = this.loadShader("src/shaders/fragment.glsl", GL20.GL_FRAGMENT_SHADER);
